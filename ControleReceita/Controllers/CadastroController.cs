...
namespace ControleReceita.Controllers
{
    public class CadastroController : Controller
    {
        ...
        [HttpGet]
        public async Task<ActionResult<List<ReceitaView>>> Listar()
        {
            List<ReceitaView> lista = new List<ReceitaView>();
            lista = this.mapper.Map<List<ReceitaView>>(await this.serviceReceita.GetTs());
            return View(lista);
        }
